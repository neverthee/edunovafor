...
class KnowledgeGraphBuilder:
    ...
    def __init__(self, course_id: str, progress_callback=None):
        ...
        self.api_base = get_chat_base_url()
        self.model_name = get_model_primary("text")
        ...
        # 设置路径
        self.kb_dir = os.path.join("uploads/knowledge_base", course_id)
...
class KnowledgeGraphRetriever:
    ...
    def __init__(self, course_id: str):
        ...
        self.api_key = os.getenv("LLM_API_KEY")
        self.api_base = get_chat_base_url()
        # 检索时默认使用文本主模型，可通过MODEL_TEXT_PRIMARY/LLM_MODEL覆盖
        self.model_name = get_model_primary("text")
